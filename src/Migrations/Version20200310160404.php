 ...
 */
final class Version20200310160404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE serie (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, nom VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, stoped_at DATETIME DEFAULT NULL, image LONGTEXT DEFAULT NULL, season_number INT NOT NULL, INDEX IDX_AA3A9334BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
